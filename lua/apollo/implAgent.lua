...
local function step2(user_prompt,pseudo,file_path)
  ...
  local payload={
    ...
    messages={
      {role='system',content=[[You are CodeGenGPT. Using pseudocode, workspace symbols, and the selected file's content, output ONLY one fenced markdown code block (or unified diff) implementing the feature. NO other text.]]},
